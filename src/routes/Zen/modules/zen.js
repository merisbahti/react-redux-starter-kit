...
let avaliableId = 0;
export function recieveZen (value: string, id: int): Action {
  return {
    type: RECIEVE_ZEN,
    payload: {
      value,
...
export default function counterReducer (state: ZenStateObject = initialState, action: Action): ZenStateObject {
